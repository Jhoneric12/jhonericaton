  ...
  return (
    <footer id="contact" className="px-6 py-4 md:px-10 lg:px-48">
      ...
      >
        ...
        <motion.h1 variants={fadeUp} className="text-main-color dark:text-title-color font-bold text-2xl lg:text-3xl">
          Get in Touch
        </motion.h1>
        <motion.p variants={fadeUp} className="text-main-color dark:text-title-color leading-7 md:w-[60%] lg:text-base">
        ...
        <motion.div variants={fadeUp} className="flex flex-col items-center gap-2 text-sm md:text-base">
          <Link
        ...
        <motion.div variants={fadeUp} className="hidden lg:flex items-center gap-5 pt-1">
