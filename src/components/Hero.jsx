  ...
  return (
    ...
    >
      ...
      <div className="mx-auto flex w-full max-w-5xl flex-col items-center text-center">
        <p className="mb-5 text-xs font-semibold uppercase tracking-[0.24em] text-main-color/70 dark:text-title-color/70 md:text-sm">
          Full-Stack Developer
        </p>

        <h1 className="text-main-color dark:text-title-color text-3xl font-extrabold leading-tight tracking-tight sm:text-4xl md:text-5xl lg:text-6xl">
        ...
        <p className="mt-6 max-w-3xl text-base leading-relaxed text-main-color/90 dark:text-text-color md:text-lg md:leading-relaxed">
        ...
        <div className="mt-10 inline-flex items-center gap-3 rounded-full px-5 py-2 text-sm font-medium text-main-color md:text-base dark:text-title-color">
