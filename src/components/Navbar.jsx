  ...
  return (
    <div className="z-30">
      <motion.div
        ...
        className={`${isOpen ? "fixed h-screen bg-light-main-color dark:bg-main-color top-0 bottom-0 right-0 w-[70%] md:w-[60%] flex justify-center items-center shadow-xl z-40 blur-none" : "hidden"}`}
      >
        <div className="flex flex-col gap-10 text-center text-lg text-main-color dark:text-title-color">
          <Link onClick={handleOpenMenu} href={"#works"}>
            Works
          </Link>
        ...
        <svg
          ...
          stroke-width="1.5"
          stroke="currentColor"
          className="w-6 h-6 absolute top-6 right-6 text-main-color dark:text-title-color"
        >
      ...
      <nav className="navbar flex items-center justify-between px-6 py-4 md:px-10 md:py-6 lg:px-16 lg:py-6 w-full fixed z-30 backdrop-blur-sm">
        <div className="w-auto h-auto">
          {isDark ? (
            <Link href={"#hero"}>
              <Image src={DarkMyLogo} width={50} height={45} alt="My Logo" className="w-auto h-auto" />
            </Link>
          ) : (
            <Link href={"#hero"}>
              <Image src={LightMyLogo} width={50} height={45} alt="My Logo" className="w-auto h-auto" />
            </Link>
          )}
        </div>
        <div className="flex gap-20">
          <div className="w-full gap-20 hidden lg:flex lg:items-center text-main-color dark:text-title-color font-medium">
            <Link className="hover:text-accent-color duration-300" href={"#works"}>
              Works
            </Link>
          ...
          <div className="flex items-center gap-4">
            {isDark ? (
              <svg
                ...
                stroke-width="1.5"
                stroke="currentColor"
                className="h-6 w-6 text-main-color dark:text-light-main-color"
              >
                <path
              ...
              <svg
                ...
                stroke-width="1.5"
                stroke="currentColor"
                className="w-6 h-6 text-main-color dark:text-light-main-color"
              >
                <path
                  stroke-linecap="round"
                  stroke-linejoin="round"
